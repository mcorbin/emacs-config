...
* MaizAI
   ...
   (defun maizai-complete-buffer ()
     ...
     (interactive)
     (let ((command (concat "complete-buffer.sh 'Complete this file:' "
                            (buffer-file-name)
                            " "
                            maizaiContext)))
       (progn
    ...
    (defun maizai-complete-prompt-buffer ()
      ...
      (let ((prompt (read-string "prompt: ")))
        (let ((command (concat "complete-buffer.sh "
                               (format "'%s'" prompt)
                               " "
                               (buffer-file-name)
                               " "
    ...
    (defun maizai-add-buffer-context ()
      ...
      (interactive)
      (let ((command (concat "/home/mcorbin/.local/maizai/add-file-context.sh "
                             maizaiContext
                             " "
                             (buffer-file-name))))
        (progn
   ...
   (global-set-key (kbd "C-c a c") 'maizai-async-complete-buffer)
   (global-set-key (kbd "C-c a p") 'maizai-async-complete-prompt-buffer)
