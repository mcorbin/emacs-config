...
*** Clojure
    ...
    Clojure mode
    #+BEGIN_SRC emacs-lisp
      ;; (defun indent-before-save ()
      ;;    (interactive)
      ;;    (cider-format-buffer)
      ;;    (save-buffer))

      ;; (defun mathieu-clojure-mode-hook ()
      ;;   (add-hook 'before-save-hook 'indent-before-save))
...
;          (add-hook 'clojure-mode-hook 'mathieu-clojure-mode-hook)
