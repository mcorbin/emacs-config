...
;         (plist-get (read (buffer-string)) :nickserv-password)))
     ...
     ;; foo is not my real password
     (setq circe-network-options
           '(("Freenode"
              :tls t
              :nick "mcorbin"
              :nickserv-password "foo"
              :port 6697
              )))
...
*** Clojure
    ...
    Configure CIDER for Clojurescript
    #+BEGIN_SRC emacs-lisp
...
**** cider
     ...
     #+BEGIN_SRC emacs-lisp
       ...
       (setq cider-jack-in-lein-plugins '(("cider/cider-nrepl" "0.22.0-beta8")) )
     #+END_SRC
...
*** Scheme
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package geiser
        ...
        :config
        (progn
          (setq geiser-racket-binary "/home/mathieu/racket/bin/racket")
          (add-hook 'scheme-mode-hook 'my/lisps-mode-hook)
          (add-hook 'geiser-repl-mode-hook 'my/lisps-mode-hook)))
    #+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (setenv "PATH" (concat (getenv "PATH") ":/home/mathieu/prog/go/bin"))
  (setq exec-path (append exec-path '("/home/mathieu/prog/go/bin")))
