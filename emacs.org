...
#+EMAIL: Mathieu [at] Corbin [dot] fr
...
Inspired by vdemeester emacs configuration : https://github.com/vdemeester/emacs-config
...
* Personal information 👨
  ...
  #+begin_src emacs-lisp
    (setq user-full-name "Mathieu Corbin"
          user-mail-address "corbin.math@gmail.com")
  #+end_src
...
;;   (add-to-list 'load-path "/home/mathieu/Prog/rustc/src/")
;;   (autoload 'rust-mode "rust-mode" nil t)
;;   (add-to-list 'auto-mode-alist '("\\.rs\\'" . rust-mode))


;;   (setq racer-rust-src-path "/home/mathieu/Prog/rustc/src/")
